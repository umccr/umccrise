...
12. `ribbon*`
    ...
    - There are four `ribbon`-related steps, which were implemented in Jan2018
      and might not be needed any more:
      - `ribbon_filter_manta`: generate unzipped VCF for Ribbon
      - `ribbon_filter_vcfbedtope_starts`: vcf2bedpe, grab columns 1-3 from
        BEDPE, add slop 5K
      - `ribbon_filter_vcfbedtope_ends`: vcf2bedpe, grab columns 4-6 from BEDPE,
        add slop 5K
