...
library(devtools)
library(stringr)
library(rock, lib.loc = "~/rock/umccrise")
...
```{r circos-prep}
circos_prep(outdir = "circos", manta = params$manta_vcf, cnv = params$cnvkit_calls)
plot_circos2(outdir = "circos", name = "foo")
```

```{r circos-manta-cnvkit2, out.width='80%'}
knitr::include_graphics("circos/foo_circos_cnvkit_manta.png")
```
