...
We can use the [MutationalPatterns](http://bioconductor.org/packages/release/bioc/html/MutationalPatterns.html)
R package to generate a mutation signature for our sample.
