...
effect_abbrev <- function(effects) {
  ...
  abbrev <- c(
    ...
    "chromosome_number_variation" = "chrom_numvar", "conservative_inframe_deletion" = "cons_inf_del",
    ...
    "frameshift_variant" = "frame_var", "intergenic_region" = "inter_reg", "intragenic_variant" = "intra_var",
...
sv_BND_main <- sv_BND %>%
  dplyr::select(nrow, Tier, Chr, Start, End, ID, Genes, Effect, Detail, SR_PR_alt, Ploidy, AF_PURPLE)
