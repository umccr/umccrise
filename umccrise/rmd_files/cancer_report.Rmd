...
purple_qc_summary %>%
  ...
  dplyr::bind_rows(
    dplyr::tribble(
      ...
      "CNV Summary", paste0(names(cnv_summary), ": ", cnv_summary, collapse = "; "),
...
main_pkgs <- c(
  "^bedtools$", "^bed_annotation$", "^bcftools$", "^break-point-inspector$", "^bwa",
  "^cacao", "^conpair$", "^cpsr", "^gatk", "^hmftools", "^hpc", "^mosdepth$", "^multiqc", "^ngs",
  "^pcgr", "^python$", "^r-base$", "^samtools$", "snakemake",
  "^umccrise$", "^vcfanno$") %>%
  paste(collapse = "|")
