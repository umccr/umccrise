...
params:
  ...
  af_keygenes: 'x'
  somatic_snv: 'x'
  somatic_sv: '/Users/vsaveliev/spa/tmp/umccrise_test_sv_newtsv_cluster5/E180__PRJ180261_E180-T01-D/structural/E180__PRJ180261_E180-T01-D-manta.tsv'
  purple_gene_cnv: 'x'
  purple_circos_baf: 'x'
  purple_purity: 'x'
  purple_cnv: 'x'
...
if (length(readLines(con = params$somatic_sv, n = 2)) > 1) {
  sv_all <- 
    ...
    dplyr::select(location, event, tier, effect, detail, AF, SR, PR, gene, SR_REF, PR_REF, PE, PE_REF, AF_BP1, AF_BP2, somScore, transcript) %>%
    dplyr::distinct() %>%
