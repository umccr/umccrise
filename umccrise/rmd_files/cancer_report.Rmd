...
Shown are signatures with positive Contribution values.
...
<details>
<summary>umccrise version</summary>

```{r umccrise-version}
umccrise_version <- system("umccrise --version", intern = TRUE)
```

__`r umccrise_version`__
