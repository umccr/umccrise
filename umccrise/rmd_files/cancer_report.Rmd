...
# Signatures
We can visualise the [mutational signature](https://cancer.sanger.ac.uk/cosmic/signatures) 
and allelic frequency profile of the tumor sample.
...
```{r somProfile2, warning=FALSE, out.width="60%"}
