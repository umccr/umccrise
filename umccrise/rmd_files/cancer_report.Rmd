...
sv_BND_main <- sv_BND %>%
  dplyr::select(nrow, varnum, Tier1, Tier2, Chr, Start, End,
                ID, BND_ID, BND_mate,
...
sv_BND_purple <- sv_all %>%
  ...
  dplyr::select(Chr, Start, Tier1, Tier2, Effect, Detail, Ploidy, CN, CNC, ID)
...
sv_noBND_main <- sv_noBND %>%
  dplyr::mutate(Genes = ifelse(ngen > max_genes,
                ...
                Transcript = ifelse(ntrx > max_transcripts,
                                    ...
                                    Transcript)) %>%
  dplyr::select(nrow, varnum, Type, Chr, Start, End, Tier1, Tier2, Effect,
...
sv_noBND_manygenes <- sv_noBND %>%
  ...
  dplyr::select(nrow, varnum, Type, Chr, Start, End, Tier1, Tier2,
