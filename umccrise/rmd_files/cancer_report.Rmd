...
purple_qc_summary <- dplyr::tribble(
  ...
  'MSI (indels/Mb)', glue('{p["msStatus"]} ({p["msIndelsPerMb"]})'), "MSI status & Indels per Mb",
...
### Somatic Variants Plots {.tabset .tabset-fade}
Plots represent purity/ploidy/clonality of somatic variants, generated by PURPLE.
...
#### Copy number
```{r purple-other-plots4, out.width="60%"}
knitr::include_graphics(file.path(img_dir, paste0(params$batch_name, '.copynumber.png')))
```

#### Segment scores
```{r purple-other-plots5, out.width="60%"}
knitr::include_graphics(file.path(img_dir, paste0(params$batch_name, '.segment.png')))
```

#### Minor allele ploidy
```{r purple-other-plots6, out.width="60%"}
knitr::include_graphics(file.path(img_dir, paste0(params$batch_name, '.map.png')))
```
...
PURPLE summary of copy number alterations in the UMCCR Cancer Gene panel (~1,200 genes) - description
