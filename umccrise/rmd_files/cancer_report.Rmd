...
split_sv_field = function(.data, field, is_pct = F) {
  ...
  .data %>% 
    ...
    mutate(
      ...
      !!f_q := format(!!f_q, nsmall = 2),
      !!f1_q := format(!!f1_q, nsmall = 2),
      !!f2_q := format(!!f2_q, nsmall = 2)
    )
}
...
qc_path = "~/rjn/extras/umccrise_2019_Mar/umccrise_test_data/results/bcbio_test_project/work/2016_249_18_WH_P017_2__CCR180159_VPT-WH017A/purple/2016_249_18_WH_P017_2__CCR180159_VPT-WH017A.purple.qc"
purity_path = "~/rjn/extras/umccrise_2019_Mar/umccrise_test_data/results/bcbio_test_project/work/2016_249_18_WH_P017_2__CCR180159_VPT-WH017A/purple/2016_249_18_WH_P017_2__CCR180159_VPT-WH017A.purple.purity"
