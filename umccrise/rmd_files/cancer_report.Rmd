...
if (breakpoints_tsv != NA && breakpoints_tsv != "" && file.exists(breakpoints_tsv)) {
  ...
  if (present_viruses != NA && present_viruses != "" && file.exists(present_viruses)) {
