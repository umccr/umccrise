...
#sv_path = '~/rjn/projects/Hofmann_Cromwell/sync/bcbio_114a0_GRCh37_native/2016.249.17.MH.P033/umccrised_014/2016_249_17_MH_P033__CCR170115b_MH17T002P033/structural/2016_249_17_MH_P033__CCR170115b_MH17T002P033-manta.tsv'
...
split_sv_field = function(.data, field, is_pct = F) {
  ...
  .data %>% 
    ...
    mutate(
      ...
      !!f_q  := format(!!f_q,  digits = 1) %>% str_c(ifelse(is_pct, "%", "")),
      !!f1_q := format(!!f1_q, digits = 1) %>% str_c(ifelse(is_pct, "%", "")),
      !!f2_q := format(!!f2_q, digits = 1) %>% str_c(ifelse(is_pct, "%", ""))
    )
}
