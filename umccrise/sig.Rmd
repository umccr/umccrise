...
library(devtools)
library(stringr)
ref_genome <- paste("BSgenome.Hsapiens.UCSC.", params$genome_build, sep="")
tx_ref_genome = paste("TxDb.Hsapiens.UCSC.", params$genome_build, ".knownGene", sep="")
